...
export type DashboardLogProps = JSX.IntrinsicElements["article"];

export const DashboardLogs = forwardRef<HTMLElement, DashboardLogProps>(
  function DashboardLogs({ style, ...restProps }, ref) {
